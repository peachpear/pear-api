...
class LErrorHandler extends ErrorHandler
{
	public function handleException($exception)
	{
        ...
        $controller->ajaxReturn(isset($data['errorCode']) ? $data['errorCode'] : $data['code'] ? $data['code']:500, YII_DEBUG ? $data['message'] : array(), YII_DEBUG ? $data : array());
	}
	...
	public function handleError($code, $message, $file, $line)
	{
        ...
        $controller->ajaxReturn(LError::INTERNAL_ERROR, YII_DEBUG ? $message : array(), YII_DEBUG ? $data : array());
